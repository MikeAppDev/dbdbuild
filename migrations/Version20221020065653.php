 ...
 */
final class Version20221020065653 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE build_category (build_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_E26F43B717C13F8B (build_id), INDEX IDX_E26F43B712469DE2 (category_id), PRIMARY KEY(build_id, category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
