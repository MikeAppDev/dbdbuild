 ...
 */
final class Version20221019130558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_build (category_id INT NOT NULL, build_id INT NOT NULL, INDEX IDX_5593BD9212469DE2 (category_id), INDEX IDX_5593BD9217C13F8B (build_id), PRIMARY KEY(category_id, build_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, build_id INT NOT NULL, content VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_9474526C17C13F8B (build_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE menu (id INT AUTO_INCREMENT NOT NULL, build_id INT DEFAULT NULL, category_id INT NOT NULL, page_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, menu_order INT DEFAULT NULL, is_visible TINYINT(1) NOT NULL, link VARCHAR(255) DEFAULT NULL, INDEX IDX_7D053A9317C13F8B (build_id), INDEX IDX_7D053A9312469DE2 (category_id), INDEX IDX_7D053A93C4663E4 (page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE build ADD CONSTRAINT FK_BDA0F2DB3569D950 FOREIGN KEY (featured_image_id) REFERENCES media (id)');
        ...
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C17C13F8B FOREIGN KEY (build_id) REFERENCES build (id)');
        $this->addSql('ALTER TABLE menu ADD CONSTRAINT FK_7D053A9317C13F8B FOREIGN KEY (build_id) REFERENCES build (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE build DROP FOREIGN KEY FK_BDA0F2DB3569D950');
        ...
        $this->addSql('ALTER TABLE comment DROP FOREIGN KEY FK_9474526C17C13F8B');
        $this->addSql('ALTER TABLE menu DROP FOREIGN KEY FK_7D053A9317C13F8B');
